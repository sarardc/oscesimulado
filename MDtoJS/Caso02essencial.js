...
// ── ESTAÇÃO 2: Gastroenterologia Pediátrica — Diarreia Aguda / Desidratação Moderada ──
  {
    ...
    cardAccent:"Lorem ipsum dolor sit amet.",

    instA: {
      scenario: "Lorem ipsum dolor sit amet.",
      patient: "Lorem ipsum dolor sit amet.",
    ...
    instB: {
      vitals: {
        PA: "valor" ou null se não disponível,
        FC: "valor" ou null se não disponível,
        FR: "valor" ou null se não disponível,
        Tax: "valor" ou null se não disponível,
        Peso: "valor" ou null se não disponível,
        Altura: "valor" ou null se não disponível,
        IMC: "valor" ou null se não disponível,
      },
